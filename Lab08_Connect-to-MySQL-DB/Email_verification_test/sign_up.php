...
<!-- Form đăng ký sử dụng javascript-->
 ...
 <!-- Trang chính-->
    ...
    <form class = "col-lg-4 m-auto" action = "signup_function.php" method = "post">
        <div class="form-group">
            <label for="email">Enter your email here</label>
            <input name = "email" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required>
        </div>
    ...
    <div class = "col-lg-4 m-auto">
        <p>If you already have an account so <a href="login.php">Login</a></p>
    </div>
</body>
</html>
