...
<!-- Form đăng ký sử dụng javascript-->
 ...
 <!-- Trang chính-->
    ...
    <form class = "col-lg-4 m-auto" action = "create_class.php?userid=<?php echo $user_id;?>" method = "post">
            ...
            <div class= "col-xl-5item col-4item col-3item col-sm-6 cel">
                <div class="card shadow" >
                    <div class="card-header">
                        <h4 ass="card-title ">
                        <a href="post.php?id=<?php echo $row['class_id'];?>&&userid=<?php $user_id = $_GET['userid']; echo $user_id;?>">
