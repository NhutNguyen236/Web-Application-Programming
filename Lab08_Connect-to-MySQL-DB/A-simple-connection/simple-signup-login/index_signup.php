...
<div class="container fluid border-primary align-items-center mt-5">

	<h1 class = "text-danger text-center my-4">Simple sign-up site</h1>

    <form class = "border-danger card p-4 bg-light col-md-6 mx-auto bg-secondary opct opacity-60" method = "post" action = "signup_function.php">
		<div class="form-row">
		...
		<div>
			<a href="index_login.php">Already have an account?Click here to see the magic</a>
		</div>
